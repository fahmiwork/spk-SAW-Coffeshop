...
<?php include './template_manager/navbar.php';
?>

<?php
$page = 'input_penilaian'; include './template_manager/sidebar.php';
?>
							...
							<div class="card">
								...
								<div class="card-body">
                                    ...
                                    ?>
											...
											<div class="form-group">
												<label><?php echo $kriteria[9] ?></label>
												<input type="text" class="form-control" name="kriteria10" value="<?php echo $dataku['kriteria10'] ?>">
											</div>
