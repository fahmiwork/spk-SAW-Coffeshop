          ...
          <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
              <div>                     
                ...
                <h5 class="text-white op-7 mb-2" >Selamat Datang <i><?php echo $_SESSION['username']; ?></i> di Sistem Pendukung Keputusan untuk Pemilihan Coffeshop</h5>
...
<?php
$sql = mysqli_query($koneksi, "SELECT * FROM tb_coffeshop");
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-7 col-stats">
                      <div class="numbers">
                        <p class="card-category">Coffeshop</p>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h5>Dibuat Oleh : </h5>  <br>
                   <p>nama: </p>
<img src="assets/img/aa.jpg" height="500px" width="1000px">
