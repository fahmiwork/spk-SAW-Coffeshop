...
<?php
 ...
 $krr6 = mysqli_query($koneksi, "SELECT 
      min(nilai) as minK6 FROM nilai_saw WHERE id_kriteria='6' ");
 $dd6 = mysqli_fetch_array($krr6);
...
var_dump($coba['nil2']);
 ...
 $sql7 = mysqli_query($koneksi, "SELECT * FROM nilai_saw where id_kriteria='6' ");
...
$bt1 = $bobotArray[1]/($bobotArray[1]+$bobotArray[2]+$bobotArray[3]+$bobotArray[4]+$bobotArray[5]+$bobotArray[6]);

$bt2 = $bobotArray[2]/($bobotArray[1]+$bobotArray[2]+$bobotArray[3]+$bobotArray[4]+$bobotArray[5]+$bobotArray[6]);

$bt3 = $bobotArray[3]/($bobotArray[1]+$bobotArray[2]+$bobotArray[3]+$bobotArray[4]+$bobotArray[5]+$bobotArray[6]);

$bt4 = $bobotArray[4]/($bobotArray[1]+$bobotArray[2]+$bobotArray[3]+$bobotArray[4]+$bobotArray[5]+$bobotArray[6]);

$bt5 = $bobotArray[5]/($bobotArray[1]+$bobotArray[2]+$bobotArray[3]+$bobotArray[4]+$bobotArray[5]+$bobotArray[6]);

$bt6 = $bobotArray[6]/($bobotArray[1]+$bobotArray[2]+$bobotArray[3]+$bobotArray[4]+$bobotArray[5]+$bobotArray[6]);
 ...
 while ($dt2 = mysqli_fetch_array($sql2)) {
  echo "<tr>
   ...
   echo "</td>
      <td style='text-align:center;'>";
        if ($k6 == "cost") {
          echo round($atribut['minK6']/$dt2['kriteria6'],4);
        } else {
          echo round($dt2['kriteria6']/$atribut['maxK6'],4);
        }
   echo "</td>
